...
class AssignmentController extends Controller
{
    ...
    public function show($id): JsonResponse
    {
        ...
        $assignment->load([
            ...
            'shocks.shockPoint', 'shocks.shockWorks', 'shocks.shockWorks.supply', 'shocks.workforces', 'shocks.workforces.workforceType', 'shocks.paintType', 'shocks.hourlyRate', 'shocks.status', 'otherCosts', 'ascertainments', 'ascertainments.ascertainmentType', 'receipts', 'receipts.receiptType', 'status', 'vehicle', 'claimNature', 'vehicle.brand', 'vehicle.vehicleModel', 'vehicle.color', 'vehicle.bodywork', 'insurer', 'additionalInsurer', 'broker', 'repairer', 'client', 'assignmentType', 'expertiseType', 'generalState', 'technicalConclusion', 'documentTransmitted', 'createdBy', 'updatedBy', 'deletedBy', 'closedBy', 'cancelledBy', 'editedBy', 'realizedBy', 'repairerValidatedBy', 'expertValidatedBy', 'directedBy', 'workSheetEstablishedBy', 'validatedBy', 'payments', 'invoices', 'openedBy',
            'shocks.shockWorks' => function($query) {
                $query->orderBy('position', 'asc');
            },
            'shocks.workforces' => function($query) {
