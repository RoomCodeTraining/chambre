...
class AssignmentController extends Controller
{
    ...
    public function index()
    {
        ...
        if($start_date || $end_date || $status_id || $opened_by || $created_by || $insurer_id || request()->filled('vehicle_id') || request()->filled('insurer_id') || request()->filled('repairer_id') || request()->filled('client_id') || request()->filled('assignment_type_id') || request()->filled('expertise_type_id') || request()->filled('vehicle_id') || request()->filled('client_id') || request()->filled('claim_nature_id') || request()->filled('reference_updated_by') || request()->filled('generated_by') || request()->filled('work_sheet_established_by') || request()->filled('created_by') || request()->filled('opened_by') || request()->filled('paid_by') || request()->filled('unpaid_by') || request()->filled('first_correction_validated_by') || request()->filled('first_correction_unvalidated_by') || request()->filled('second_correction_validated_by') || request()->filled('second_correction_unvalidated_by') || request()->filled('validated_by') || request()->filled('unvalidated_by') || request()->filled('cancelled_by') || request()->filled('deleted_by') || request()->filled('archived_by') || request()->filled('classified_without_further_action_by') || request()->filled('pending_for_repairer_quote_by') || request()->filled('pending_for_repairer_quote_validation_by') || request()->filled('in_editing_by') || request()->filled('in_first_correction_by') || request()->filled('in_second_correction_by') || request()->filled('pending_for_repairer_validation_by') || request()->filled('pending_for_expert_validation_by') || request()->filled('validated_by_repairer_by') || request()->filled('unvalidated_by_repairer_by') || request()->filled('validated_by_expert_by') || request()->filled('unvalidated_by_expert_by') || request()->filled('agreement_for_work_subject_to_conditions_by') || request()->filled('quote_validated_by_repairer_by') || request()->filled('quote_unvalidated_by_repairer_at') || request()->filled('quote_validated_by_expert_by') || request()->filled('quote_unvalidated_by_expert_by') || request()->filled('edition_unvalidated_by') || request()->filled('edition_validated_by')){
